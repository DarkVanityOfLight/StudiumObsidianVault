Ein __Unifikator__ einer [Menge](Mengen.md) $U$ von [Literalen](Logik/Literal.md) ist eine [Substitution](Substitution.md), die alle Literale in $U$ gleichsetzt. Hat $U$ einen Unifikator, wird es __unifizierbar__ genannt.
