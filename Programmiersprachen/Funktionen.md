...
$$
Der Rumpf einer Funktion wird in der um den formalen Parameter erweiterten [Signatur](Programmiersprachen/Signatur.md) getypt (',' ist der [Die Erweiterung(Kommaoperator)](Endliche%20Abbildungen.md#Die%20Erweiterung(Kommaoperator))).
